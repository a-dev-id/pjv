@section('title', 'New Wedding')
@section('wedding-list_active', 'active')
...
<x-app-layout>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <form method="POST" action="{{ route('wedding-list.store') }}" enctype="multipart/form-data" class="col-lg-12">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Type something" name="button_text">
                                    </div>
                                    <div class="form-group">
                                        <label>Button Link</label>
                                        <input type="text" class="form-control" placeholder="Type something" name="button_link">
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
