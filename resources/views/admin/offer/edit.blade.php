...
<x-app-layout>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('offer-list.index') }}">Home</a></li>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <form method="POST" action="{{ route('offer-list.update', [$edit_data->id]) }}" enctype="multipart/form-data" class="col-lg-12">
                    @method('PUT')
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        <label>Excerpt</label>
                                        <textarea name="excerpt" class="form-control" rows="5">{{ $edit_data->excerpt }}</textarea>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Type something" name="button_text" value="{{ $edit_data->button_text }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Button Link</label>
                                        <input type="text" class="form-control" placeholder="Type something" name="button_link" value="{{ $edit_data->button_link }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
