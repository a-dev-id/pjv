...
<x-app-layout>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <form method="POST" action="{{ route('villa-list.update', [$edit_data->id]) }}" enctype="multipart/form-data" class="col-lg-12">
                    {{-- <form method="POST" action="{{ route('villa-list.store') }}" enctype="multipart/form-data" class="col-lg-12"> --}}
                        @method('PUT')
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="metadescription" name="meta_description">{{ $edit_data->meta_description }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
