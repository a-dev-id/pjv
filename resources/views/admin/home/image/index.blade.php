    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form method="POST" action="{{ route('villa-image.destroy', [$data->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
                ...
                <form method="POST" action="{{ route('villa-image.store') }}" enctype="multipart/form-data" class="col-lg-4">
                    @csrf
