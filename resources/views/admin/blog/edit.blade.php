...
<x-app-layout>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('blog-list.index') }}">Home</a></li>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <form method="POST" action="{{ route('blog-list.update', [$edit_data->id]) }}" enctype="multipart/form-data" class="col-lg-12">
                    @method('PUT')
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        <label>Excerpt</label>
                                        <textarea class="form-control" name="excerpt" rows="5" placeholder="Type something">{{ $edit_data->excerpt }}</textarea>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="{{ asset($edit_data->banner_image) }}" style="width: 100%">
                                            <input type="hidden" name="old_banner_image" value="{{ $edit_data->banner_image }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Meta Title</label>
                                        <input type="text" class="form-control" placeholder="Type something" name="meta_title" value="{{ $edit_data->meta_title }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Meta Description</label>
                                        <textarea id="meta_description" name="meta_description">{{ $edit_data->meta_description }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
