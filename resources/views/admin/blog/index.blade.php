    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('blog-list.create') }}" class="btn btn-success font-weight-bold"><i class="fas fa-plus"></i> New
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="list" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('blog-list.edit', [$data->id]) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form method="POST" action="{{ route('blog-list.destroy', [$data->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
                ...
                <form method="POST" action="{{ route('blog-setting.update', [$setting->id]) }}" enctype="multipart/form-data" class="col-lg-12">
                    @method('PUT')
                    @csrf
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        <label>Excerpt</label>
                                        <textarea class="form-control" name="excerpt" rows="5" placeholder="Type something">{{ $setting->excerpt }}</textarea>
                                    </div>
                                    <div class="form-group">
