...
<x-app-layout>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <form method="POST" action="{{ route('blog-list.store') }}" enctype="multipart/form-data" class="col-lg-12">
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        <label>Excerpt</label>
                                        <textarea class="form-control" name="excerpt" rows="5" placeholder="Type something"></textarea>
                                    </div>
                                    <div class="form-group">
