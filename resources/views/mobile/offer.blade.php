            ...
            <div class="background-home">
                <div class="col-md-12">
                    <div class="benefit-mobile">
                        <h1 style="font-weight: bold;">Book Direct Benefit</h1>
                        <ul class="fa-ul">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a id="btn-k" data-toggle="collapse" data-parent="#accordion" href="#collapse10" class="ff-giveaway" style="font-weight: bold;">{{ $data->title }}<span><i id="icon-kj" class="fa fa-angle-up  go" aria-hidden="true" style="font-size: 25px;margin-top: -4px;"></i></span></a>
                                </h4>
                            </div>
